...
<input type="hidden" name="opcion" value="2">
 ...
 <div class="col-md-7 mb-7">
    ...
    <div class="col-md-7 mb-6">
      ...
      value="<?php echo $animal->nombre ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $animal->grupo ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
    ...
    <div class="col-md-7 mb-7">
      ...
      <div class="col-sm-10">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="sexo" id="gridRadios1" value="macho"  required>
          <label class="form-check-label" for="gridRadios1">
            Macho
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="sexo" id="gridRadios2" value="hembra" required>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $animal->alimentacion ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $animal->foto ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      value="<?php echo $animal->estatus ?>" required>
      <div class="valid-feedback">
      Dato validado!
      </div>
    </div>
