...
<input type="hidden" name="opcion" value="1">
 ...
 <div class="col-md-7 mb-7">
  ...
  <div class="col-md-7 mb-7">
      ...
      <input type="text" class="form-control" name="grupo" id="validationCustom02"  required>
    </div>
  </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      <input type="text" class="form-control" name="alimentacion" id="validationCustom02"  required>
    </div>
  </div>
