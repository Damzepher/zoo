    ...
    <div class="col-md-7 mb-7">
      ...
      <div class="col-sm-10">
        ...
        <input class="form-check-input" type="radio" name="genero" id="inlineRadio2" value="Hombre"  >
          ...
          <input class="form-check-input" type="radio" name="sexo" id="gridRadios1" value="masculino"  <?php echo ($empleado->sexo=="masculino"?'checked':'') ?>  readonly >
          <label class="form-check-label" for="gridRadios1">
            Masculino
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="sexo" id="gridRadios2" value="femenino"   <?php echo ($empleado->sexo=="femenino"?'checked':'') ?>  readonly  >
