...
<input type="hidden" name="opcion" value="1">
 ...
 <div class="col-md-7 mb-7">
  ...
  <div class="col-md-7 mb-6">
      ...
      <input type="text" class="form-control" name="puesto" id="validationCustom02"  required>
    </div>

    <div class="col-md-7 mb-6">
      <label for="validationCustom02">Horario</label>
      <input type="text" class="form-control" name="horario" id="validationCustom02"  required>
    </div>
